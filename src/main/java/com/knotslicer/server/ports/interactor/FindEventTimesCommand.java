...
public class FindEventTimesCommand implements InteractorCommand {
    private Map<Long, Schedule> schedules;
    private Set<Member> members;
    private EntityCreator entityCreator;
    private Map<Set<Long>, Poll> memo = new HashMap<>();
    private Set<Poll> solutions;
    private static final Logger logger
            = LoggerFactory.getLogger(FindEventTimesCommand.class);
    public FindEventTimesCommand(Map<Long, Schedule> schedules,
                                 Set<Member> members,
                                 Set<Poll> solutions,
